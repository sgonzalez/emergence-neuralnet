...
*TLDR: Feedforward neural networks can be dynamically build / loaded and trained in a supervised manner. Networks can be connected together with a coordinator.*
